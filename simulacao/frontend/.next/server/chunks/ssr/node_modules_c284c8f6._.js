...
`;var _=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aa=class extends Z.LitElement{constructor(){super(...arguments),this.radius=36}render(){return this.svgLoaderTemplate()}svgLoaderTemplate(){let a=this.radius>50?50:this.radius,b=36-a;return c.html`
    ...
    `}};aa.styles=[L.resetStyles,$],_([(0,k.property)({type:Number})],aa.prototype,"radius",void 0),aa=_([(0,i.customElement)("wui-loading-thumbnail")],aa),a.i(145357),a.i(926383);var ab=b,ac=a.i(412646),ad=b;a.i(80336),a.i(747627);let ae=y.css`
  wui-flex {
    width: 100%;
    height: 52px;
    box-sizing: border-box;
...
`;var af=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let ag=class extends ad.LitElement{constructor(){super(...arguments),this.disabled=!1,this.label="",this.buttonLabel=""}render(){return c.html`
    ...
    `}};ag.styles=[L.resetStyles,L.elementStyles,ae],af([(0,k.property)({type:Boolean})],ag.prototype,"disabled",void 0),af([(0,k.property)()],ag.prototype,"label",void 0),af([(0,k.property)()],ag.prototype,"buttonLabel",void 0),ag=af([(0,i.customElement)("wui-cta-button")],ag);let ah=y.css`
  :host {
    display: block;
    padding: 0 ${({spacing:a})=>a["5"]} ${({spacing:a})=>a["5"]};
  }
`;var ai=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aj=class extends ab.LitElement{constructor(){super(...arguments),this.wallet=void 0}render(){if(!this.wallet)return this.style.display="none",null;let{name:a,app_store:b,play_store:d,chrome_store:e,homepage:g}=this.wallet,h=f.CoreHelperUtil.isMobile(),i=f.CoreHelperUtil.isIos(),j=f.CoreHelperUtil.isAndroid(),k=[b,d,g,e].filter(Boolean).length>1,l=ac.UiHelperUtil.getTruncateString({string:a,charsStart:12,charsEnd:0,truncate:"end"});return k&&!h?c.html`
        <wui-cta-button
          label=${`Don't have ${l}?`}
          buttonLabel="Get"
...
`;var ax=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let ay=class extends as.LitElement{constructor(){super(...arguments),this.uri="",this.size=500,this.theme="dark",this.imageSrc=void 0,this.alt=void 0,this.arenaClear=void 0,this.farcaster=void 0}render(){return this.dataset.theme=this.theme,this.dataset.clear=String(this.arenaClear),c.html`<wui-flex
      alignItems="center"
    ...
    >
      ...
      <svg viewBox="0 0 ${this.size} ${this.size}" width="100%" height="100%">
        ${av.generate({uri:this.uri,size:this.size,logoSize:this.arenaClear?0:this.size/4})}
      </svg>
    `}templateVisual(){return this.imageSrc?c.html`<wui-image src=${this.imageSrc} alt=${this.alt??"logo"}></wui-image>`:this.farcaster?c.html`<wui-icon
        ...
        color="inherit"
        name="farcaster"
      ></wui-icon>`:c.html`<wui-icon size="inherit" color="inherit" name="walletConnect"></wui-icon>`}};ay.styles=[L.resetStyles,aw],ax([(0,k.property)()],ay.prototype,"uri",void 0),ax([(0,k.property)({type:Number})],ay.prototype,"size",void 0),ax([(0,k.property)()],ay.prototype,"theme",void 0),ax([(0,k.property)()],ay.prototype,"imageSrc",void 0),ax([(0,k.property)()],ay.prototype,"alt",void 0),ax([(0,k.property)({type:Boolean})],ay.prototype,"arenaClear",void 0),ax([(0,k.property)({type:Boolean})],ay.prototype,"farcaster",void 0),ay=ax([(0,i.customElement)("wui-qr-code")],ay);var az=b;let aA=y.css`
  :host {
    display: block;
...
`;var aB=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aC=class extends az.LitElement{constructor(){super(...arguments),this.width="",this.height="",this.variant="default",this.rounded=!1}render(){return this.style.cssText=`
      width: ${this.width};
      height: ${this.height};
    `,this.dataset.rounded=this.rounded?"true":"false",c.html`<slot></slot>`}};aC.styles=[aA],aB([(0,k.property)()],aC.prototype,"width",void 0),aB([(0,k.property)()],aC.prototype,"height",void 0),aB([(0,k.property)()],aC.prototype,"variant",void 0),aB([(0,k.property)({type:Boolean})],aC.prototype,"rounded",void 0),aC=aB([(0,i.customElement)("wui-shimmer")],aC),a.i(575402);let aD=y.css`
  wui-shimmer {
    width: 100%;
    aspect-ratio: 1 / 1;
    border-radius: ${({borderRadius:a})=>a[4]};
...
`;var aE=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aF=class extends am{constructor(){super(),this.basic=!1}firstUpdated(){this.basic||p.EventsController.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet?.name??"WalletConnect",platform:"qrcode",displayIndex:this.wallet?.display_index,walletRank:this.wallet?.order,view:q.RouterController.state.view}})}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.forEach(a=>a())}render(){return this.onRenderProxy(),c.html`
      <wui-flex
        flexDirection="column"
        alignItems="center"
        .padding=${["0","5","5","5"]}
    ...
    `}onRenderProxy(){!this.ready&&this.uri&&(this.ready=!0)}qrCodeTemplate(){if(!this.uri||!this.ready)return null;let a=this.wallet?this.wallet.name:void 0;return n.ConnectionController.setWcLinking(void 0),n.ConnectionController.setRecentWallet(this.wallet),c.html` <wui-qr-code
    ...
    >
    ...
    </wui-button>`}};aF.styles=aD,aE([(0,k.property)({type:Boolean})],aF.prototype,"basic",void 0),aF=aE([(0,i.customElement)("w3m-connecting-wc-qrcode")],aF);var aG=b;let aH=class extends aG.LitElement{constructor(){if(super(),this.wallet=q.RouterController.state.data?.wallet,!this.wallet)throw Error("w3m-connecting-wc-unsupported: No wallet provided");p.EventsController.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"browser",displayIndex:this.wallet?.display_index,walletRank:this.wallet?.order,view:q.RouterController.state.view}})}render(){return c.html`
      <wui-flex
        flexDirection="column"
        alignItems="center"
        .padding=${["10","5","5","5"]}
      ...
      <w3m-mobile-download-links .wallet=${this.wallet}></w3m-mobile-download-links>
    `}};aH=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g}([(0,i.customElement)("w3m-connecting-wc-unsupported")],aH);var aI=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aJ=class extends am{constructor(){if(super(),this.isLoading=!0,!this.wallet)throw Error("w3m-connecting-wc-web: No wallet provided");this.onConnect=this.onConnectProxy.bind(this),this.secondaryBtnLabel="Open",this.secondaryLabel=ap.ConstantsUtil.CONNECT_LABELS.MOBILE,this.secondaryBtnIcon="externalLink",this.updateLoadingState(),this.unsubscribe.push(n.ConnectionController.subscribeKey("wcUri",()=>{this.updateLoadingState()})),p.EventsController.sendEvent({type:"track",event:"SELECT_WALLET",properties:{name:this.wallet.name,platform:"web",displayIndex:this.wallet?.display_index,walletRank:this.wallet?.order,view:q.RouterController.state.view}})}updateLoadingState(){this.isLoading=!this.uri}onConnectProxy(){if(this.wallet?.webapp_link&&this.uri)try{this.error=!1;let{webapp_link:a,name:b}=this.wallet,{redirect:c,href:d}=f.CoreHelperUtil.formatUniversalUrl(a,this.uri);n.ConnectionController.setWcLinking({name:b,href:d}),n.ConnectionController.setRecentWallet(this.wallet),f.CoreHelperUtil.openHref(c,"_blank")}catch{this.error=!0}}};aI([(0,d.state)()],aJ.prototype,"isLoading",void 0),aJ=aI([(0,i.customElement)("w3m-connecting-wc-web")],aJ);let aK=y.css`
...
`;var aL=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aM=class extends C.LitElement{constructor(){super(),this.wallet=q.RouterController.state.data?.wallet,this.unsubscribe=[],this.platform=void 0,this.platforms=[],this.isSiwxEnabled=!!g.OptionsController.state.siwx,this.remoteFeatures=g.OptionsController.state.remoteFeatures,this.displayBranding=!0,this.basic=!1,this.determinePlatforms(),this.initializeConnection(),this.unsubscribe.push(g.OptionsController.subscribeKey("remoteFeatures",a=>this.remoteFeatures=a))}disconnectedCallback(){this.unsubscribe.forEach(a=>a())}render(){return g.OptionsController.state.enableMobileFullScreen&&this.setAttribute("data-mobile-fullscreen","true"),c.html`
      ${this.headerTemplate()}
    ...
    `:null}async onSelectPlatform(a){let b=this.shadowRoot?.querySelector("div");b&&(await b.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.platform=a,b.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"}))}};aM.styles=aK,aL([(0,d.state)()],aM.prototype,"platform",void 0),aL([(0,d.state)()],aM.prototype,"platforms",void 0),aL([(0,d.state)()],aM.prototype,"isSiwxEnabled",void 0),aL([(0,d.state)()],aM.prototype,"remoteFeatures",void 0),aL([(0,k.property)({type:Boolean})],aM.prototype,"displayBranding",void 0),aL([(0,k.property)({type:Boolean})],aM.prototype,"basic",void 0),aM=aL([(0,i.customElement)("w3m-connecting-wc-view")],aM);var aN=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let aO=class extends b.LitElement{constructor(){super(),this.unsubscribe=[],this.isMobile=f.CoreHelperUtil.isMobile(),this.remoteFeatures=g.OptionsController.state.remoteFeatures,this.unsubscribe.push(g.OptionsController.subscribeKey("remoteFeatures",a=>this.remoteFeatures=a))}disconnectedCallback(){this.unsubscribe.forEach(a=>a())}render(){if(this.isMobile){let{featured:a,recommended:b}=e.ApiController.state,{customWallets:d}=g.OptionsController.state,f=h.StorageUtil.getRecentWallets(),i=a.length||b.length||d?.length||f.length;return c.html`<wui-flex flexDirection="column" gap="2" .margin=${["1","3","3","3"]}>
    ...
    </wui-flex>`:null}};aN([(0,d.state)()],aO.prototype,"isMobile",void 0),aN([(0,d.state)()],aO.prototype,"remoteFeatures",void 0),aO=aN([(0,i.customElement)("w3m-connecting-wc-basic-view")],aO),a.s(["W3mConnectingWcBasicView",()=>aO],651415);var aP=b,aQ=b,aR=b;let{I:aS}=c._$LH;var aT=a.i(451096);let aU=(a,b)=>{let c=a._$AN;if(void 0===c)return!1;for(let a of c)a._$AO?.(b,!1),aU(a,b);return!0},aV=a=>{let b,c;do{if(void 0===(b=a._$AM))break;(c=b._$AN).delete(a),a=b}while(0===c?.size)},aW=a=>{for(let b;b=a._$AM;a=b){let c=b._$AN;if(void 0===c)b._$AN=c=new Set;else if(c.has(a))break;c.add(a),aZ(b)}};function aX(a){void 0!==this._$AN?(aV(this),this._$AM=a,aW(this)):this._$AM=a}function aY(a,b=!1,c=0){let d=this._$AH,e=this._$AN;if(void 0!==e&&0!==e.size)if(b)if(Array.isArray(d))for(let a=c;a<d.length;a++)aU(d[a],!1),aV(d[a]);else null!=d&&(aU(d,!1),aV(d));else aU(this,a)}let aZ=a=>{a.type==aT.PartType.CHILD&&(a._$AP??=aY,a._$AQ??=aX)};class a$ extends aT.Directive{constructor(){super(...arguments),this._$AN=void 0}_$AT(a,b,c){super._$AT(a,b,c),aW(this),this.isConnected=a._$AU}_$AO(a,b=!0){a!==this.isConnected&&(this.isConnected=a,a?this.reconnected?.():this.disconnected?.()),b&&(aU(this,a),aV(this))}setValue(a){if(void 0===this._$Ct.strings)this._$Ct._$AI(a,this);else{let b=[...this._$Ct._$AH];b[this._$Ci]=a,this._$Ct._$AI(b,this,0)}}disconnected(){}reconnected(){}}let a_=()=>new a0;class a0{}let a1=new WeakMap,a2=(0,aT.directive)(class extends a${render(a){return c.nothing}update(a,[b]){let d=b!==this.G;return d&&void 0!==this.G&&this.rt(void 0),(d||this.lt!==this.ct)&&(this.G=b,this.ht=a.options?.host,this.rt(this.ct=a.element)),c.nothing}rt(a){if(this.isConnected||(a=void 0),"function"==typeof this.G){let b=this.ht??globalThis,c=a1.get(b);void 0===c&&(c=new WeakMap,a1.set(b,c)),void 0!==c.get(this.G)&&this.G.call(this.ht,void 0),c.set(this.G,a),void 0!==a&&this.G.call(this.ht,a)}else this.G.value=a}get lt(){return"function"==typeof this.G?a1.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),a3=y.css`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
...
`;var a4=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let a5=class extends aR.LitElement{constructor(){super(...arguments),this.inputElementRef=a_(),this.checked=!1,this.disabled=!1,this.size="md"}render(){return c.html`
      <label data-size=${this.size}>
        <input
          ${a2(this.inputElementRef)}
          type="checkbox"
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent("switchChange",{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};a5.styles=[L.resetStyles,L.elementStyles,a3],a4([(0,k.property)({type:Boolean})],a5.prototype,"checked",void 0),a4([(0,k.property)({type:Boolean})],a5.prototype,"disabled",void 0),a4([(0,k.property)()],a5.prototype,"size",void 0),a5=a4([(0,i.customElement)("wui-toggle")],a5);let a6=y.css`
  :host {
    height: auto;
  }
...
`;var a7=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let a8=class extends aQ.LitElement{constructor(){super(...arguments),this.checked=!1}render(){return c.html`
      <wui-flex>
    ...
    `}handleToggleChange(a){a.stopPropagation(),this.checked=a.detail,this.dispatchSwitchEvent()}dispatchSwitchEvent(){this.dispatchEvent(new CustomEvent("certifiedSwitchChange",{detail:this.checked,bubbles:!0,composed:!0}))}};a8.styles=[L.resetStyles,L.elementStyles,a6],a7([(0,k.property)({type:Boolean})],a8.prototype,"checked",void 0),a8=a7([(0,i.customElement)("wui-certified-switch")],a8);var a9=b,ba=b;let bb=y.css`
  :host {
    position: relative;
    width: 100%;
    display: inline-flex;
...
`;var bc=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bd=class extends ba.LitElement{constructor(){super(...arguments),this.inputElementRef=a_(),this.disabled=!1,this.loading=!1,this.placeholder="",this.type="text",this.value="",this.size="md"}render(){return c.html` <div class="wui-input-text-container">
      ...
      </button>`:null}templateError(){return this.errorText?c.html`<wui-text variant="sm-regular" color="error">${this.errorText}</wui-text>`:null}templateWarning(){return this.warningText?c.html`<wui-text variant="sm-regular" color="warning">${this.warningText}</wui-text>`:null}dispatchInputChangeEvent(){this.dispatchEvent(new CustomEvent("inputChange",{detail:this.inputElementRef.value?.value,bubbles:!0,composed:!0}))}};bd.styles=[L.resetStyles,L.elementStyles,bb],bc([(0,k.property)()],bd.prototype,"icon",void 0),bc([(0,k.property)({type:Boolean})],bd.prototype,"disabled",void 0),bc([(0,k.property)({type:Boolean})],bd.prototype,"loading",void 0),bc([(0,k.property)()],bd.prototype,"placeholder",void 0),bc([(0,k.property)()],bd.prototype,"type",void 0),bc([(0,k.property)()],bd.prototype,"value",void 0),bc([(0,k.property)()],bd.prototype,"errorText",void 0),bc([(0,k.property)()],bd.prototype,"warningText",void 0),bc([(0,k.property)()],bd.prototype,"onSubmit",void 0),bc([(0,k.property)()],bd.prototype,"size",void 0),bc([(0,k.property)({attribute:!1})],bd.prototype,"onKeyDown",void 0),bd=bc([(0,i.customElement)("wui-input-text")],bd);let be=y.css`
  :host {
    position: relative;
    display: inline-block;
    width: 100%;
...
`;var bf=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bg=class extends a9.LitElement{constructor(){super(...arguments),this.inputComponentRef=a_(),this.inputValue=""}render(){return c.html`
      <wui-input-text
        ${a2(this.inputComponentRef)}
    ...
    `}onInputChange(a){this.inputValue=a.detail||""}clearValue(){let a=this.inputComponentRef.value,b=a?.inputElementRef.value;b&&(b.value="",this.inputValue="",b.focus(),b.dispatchEvent(new Event("input")))}};bg.styles=[L.resetStyles,be],bf([(0,k.property)()],bg.prototype,"inputValue",void 0),bg=bf([(0,i.customElement)("wui-search-bar")],bg);var bh=b,bi=b;let bj=c.svg`<svg  viewBox="0 0 48 54" fill="none">
  <path
...
`;var bl=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bm=class extends bi.LitElement{constructor(){super(...arguments),this.type="wallet"}render(){return c.html`
    ...
    `}shimmerTemplate(){return"network"===this.type?c.html` <wui-shimmer data-type=${this.type} width="48px" height="54px"></wui-shimmer>
        ${bj}`:c.html`<wui-shimmer width="56px" height="56px"></wui-shimmer>`}};bm.styles=[L.resetStyles,L.elementStyles,bk],bl([(0,k.property)()],bm.prototype,"type",void 0),bm=bl([(0,i.customElement)("wui-card-select-loader")],bm);var bn=b,bo=a.i(885876);let bp=bo.css`
  :host {
    display: grid;
    width: inherit;
    height: inherit;
  }
`;var bq=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let br=class extends bn.LitElement{render(){return this.style.cssText=`
      ...
      padding-top: ${this.padding&&ac.UiHelperUtil.getSpacingStyles(this.padding,0)};
      padding-right: ${this.padding&&ac.UiHelperUtil.getSpacingStyles(this.padding,1)};
      padding-bottom: ${this.padding&&ac.UiHelperUtil.getSpacingStyles(this.padding,2)};
      padding-left: ${this.padding&&ac.UiHelperUtil.getSpacingStyles(this.padding,3)};
      margin-top: ${this.margin&&ac.UiHelperUtil.getSpacingStyles(this.margin,0)};
      margin-right: ${this.margin&&ac.UiHelperUtil.getSpacingStyles(this.margin,1)};
      margin-bottom: ${this.margin&&ac.UiHelperUtil.getSpacingStyles(this.margin,2)};
      margin-left: ${this.margin&&ac.UiHelperUtil.getSpacingStyles(this.margin,3)};
    `,c.html`<slot></slot>`}};br.styles=[L.resetStyles,bp],bq([(0,k.property)()],br.prototype,"gridTemplateRows",void 0),bq([(0,k.property)()],br.prototype,"gridTemplateColumns",void 0),bq([(0,k.property)()],br.prototype,"justifyItems",void 0),bq([(0,k.property)()],br.prototype,"alignItems",void 0),bq([(0,k.property)()],br.prototype,"justifyContent",void 0),bq([(0,k.property)()],br.prototype,"alignContent",void 0),bq([(0,k.property)()],br.prototype,"columnGap",void 0),bq([(0,k.property)()],br.prototype,"rowGap",void 0),bq([(0,k.property)()],br.prototype,"gap",void 0),bq([(0,k.property)()],br.prototype,"padding",void 0),bq([(0,k.property)()],br.prototype,"margin",void 0),br=bq([(0,i.customElement)("wui-grid")],br);var bs=a.i(951028),bt=b;let bu=y.css`
  button {
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`;var bv=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bw=class extends bt.LitElement{constructor(){super(),this.observer=new IntersectionObserver(()=>void 0),this.visible=!1,this.imageSrc=void 0,this.imageLoading=!1,this.isImpressed=!1,this.explorerId="",this.walletQuery="",this.certified=!1,this.displayIndex=0,this.wallet=void 0,this.observer=new IntersectionObserver(a=>{a.forEach(a=>{a.isIntersecting?(this.visible=!0,this.fetchImageSrc(),this.sendImpressionEvent()):this.visible=!1})},{threshold:.01})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){let a=this.wallet?.badge_type==="certified";return c.html`
      <button>
        ${this.imageTemplate()}
    ...
    `:this.shimmerTemplate()}shimmerTemplate(){return c.html`<wui-shimmer width="56px" height="56px"></wui-shimmer>`}async fetchImageSrc(){!this.wallet||(this.imageSrc=v.AssetUtil.getWalletImage(this.wallet),this.imageSrc||(this.imageLoading=!0,this.imageSrc=await v.AssetUtil.fetchWalletImage(this.wallet.image_id),this.imageLoading=!1))}sendImpressionEvent(){this.wallet&&!this.isImpressed&&(this.isImpressed=!0,p.EventsController.sendWalletImpressionEvent({name:this.wallet.name,walletRank:this.wallet.order,explorerId:this.explorerId,view:q.RouterController.state.view,query:this.walletQuery,certified:this.certified,displayIndex:this.displayIndex}))}};bw.styles=bu,bv([(0,d.state)()],bw.prototype,"visible",void 0),bv([(0,d.state)()],bw.prototype,"imageSrc",void 0),bv([(0,d.state)()],bw.prototype,"imageLoading",void 0),bv([(0,d.state)()],bw.prototype,"isImpressed",void 0),bv([(0,k.property)()],bw.prototype,"explorerId",void 0),bv([(0,k.property)()],bw.prototype,"walletQuery",void 0),bv([(0,k.property)()],bw.prototype,"certified",void 0),bv([(0,k.property)()],bw.prototype,"displayIndex",void 0),bv([(0,k.property)({type:Object})],bw.prototype,"wallet",void 0),bw=bv([(0,i.customElement)("w3m-all-wallets-list-item")],bw);let bx=y.css`
  wui-grid {
...
`;var by=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bz="local-paginator",bA=class extends bh.LitElement{constructor(){super(),this.unsubscribe=[],this.paginationObserver=void 0,this.loading=!e.ApiController.state.wallets.length,this.wallets=e.ApiController.state.wallets,this.recommended=e.ApiController.state.recommended,this.featured=e.ApiController.state.featured,this.filteredWallets=e.ApiController.state.filteredWallets,this.mobileFullScreen=g.OptionsController.state.enableMobileFullScreen,this.unsubscribe.push(e.ApiController.subscribeKey("wallets",a=>this.wallets=a),e.ApiController.subscribeKey("recommended",a=>this.recommended=a),e.ApiController.subscribeKey("featured",a=>this.featured=a),e.ApiController.subscribeKey("filteredWallets",a=>this.filteredWallets=a))}firstUpdated(){this.initialFetch(),this.createPaginationObserver()}disconnectedCallback(){this.unsubscribe.forEach(a=>a()),this.paginationObserver?.disconnect()}render(){return this.mobileFullScreen&&this.setAttribute("data-mobile-fullscreen","true"),c.html`
    ...
    `}async initialFetch(){this.loading=!0;let a=this.shadowRoot?.querySelector("wui-grid");a&&(await e.ApiController.fetchWalletsByPage({page:1}),await a.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.loading=!1,a.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"}))}shimmerTemplate(a,b){return[...Array(a)].map(()=>c.html`
      ...
      `)}getWallets(){let a=[...this.featured,...this.recommended];this.filteredWallets?.length>0?a.push(...this.filteredWallets):a.push(...this.wallets);let b=f.CoreHelperUtil.uniqueBy(a,"id"),c=bs.WalletUtil.markWalletsAsInstalled(b);return bs.WalletUtil.markWalletsWithDisplayIndex(c)}walletsTemplate(){return this.getWallets().map((a,b)=>c.html`
        <w3m-all-wallets-list-item
          ...
          displayIndex=${b}
        ></w3m-all-wallets-list-item>
      `)}paginationLoaderTemplate(){let{wallets:a,recommended:b,featured:c,count:d,mobileFilteredOutWalletsLength:f}=e.ApiController.state,g=window.innerWidth<352?3:4,h=a.length+b.length,i=Math.ceil(h/g)*g-h+g;return(i-=a.length?c.length%g:0,0===d&&c.length>0)?null:0===d||[...c,...a,...b].length<d-(f??0)?this.shimmerTemplate(i,bz):null}createPaginationObserver(){let a=this.shadowRoot?.querySelector(`#${bz}`);a&&(this.paginationObserver=new IntersectionObserver(([a])=>{if(a?.isIntersecting&&!this.loading){let{page:a,count:b,wallets:c}=e.ApiController.state;c.length<b&&e.ApiController.fetchWalletsByPage({page:a+1})}}),this.paginationObserver.observe(a))}onConnectWallet(a){o.ConnectorController.selectWalletConnector(a)}};bA.styles=bx,by([(0,d.state)()],bA.prototype,"loading",void 0),by([(0,d.state)()],bA.prototype,"wallets",void 0),by([(0,d.state)()],bA.prototype,"recommended",void 0),by([(0,d.state)()],bA.prototype,"featured",void 0),by([(0,d.state)()],bA.prototype,"filteredWallets",void 0),by([(0,d.state)()],bA.prototype,"badge",void 0),by([(0,d.state)()],bA.prototype,"mobileFullScreen",void 0),bA=by([(0,i.customElement)("w3m-all-wallets-list")],bA);var bB=b;a.i(488535);let bC=bo.css`
  wui-grid,
  wui-loading-spinner,
  wui-flex {
    height: 360px;
...
`;var bD=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bE=class extends bB.LitElement{constructor(){super(...arguments),this.prevQuery="",this.prevBadge=void 0,this.loading=!0,this.mobileFullScreen=g.OptionsController.state.enableMobileFullScreen,this.query=""}render(){return this.mobileFullScreen&&this.setAttribute("data-mobile-fullscreen","true"),this.onSearch(),this.loading?c.html`<wui-loading-spinner color="accent-primary"></wui-loading-spinner>`:this.walletsTemplate()}async onSearch(){(this.query.trim()!==this.prevQuery.trim()||this.badge!==this.prevBadge)&&(this.prevQuery=this.query,this.prevBadge=this.badge,this.loading=!0,await e.ApiController.searchWallet({search:this.query,badge:this.badge}),this.loading=!1)}walletsTemplate(){let{search:a}=e.ApiController.state,b=bs.WalletUtil.markWalletsAsInstalled(a);return a.length?c.html`
      <wui-grid
    ...
    `:c.html`
      ...
      `}onConnectWallet(a){o.ConnectorController.selectWalletConnector(a)}};bE.styles=bC,bD([(0,d.state)()],bE.prototype,"loading",void 0),bD([(0,d.state)()],bE.prototype,"mobileFullScreen",void 0),bD([(0,k.property)()],bE.prototype,"query",void 0),bD([(0,k.property)()],bE.prototype,"badge",void 0),bE=bD([(0,i.customElement)("w3m-all-wallets-search")],bE);var bF=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bG=class extends aP.LitElement{constructor(){super(...arguments),this.search="",this.badge=void 0,this.onDebouncedSearch=f.CoreHelperUtil.debounce(a=>{this.search=a})}render(){let a=this.search.length>=2;return c.html`
    ...
    `}onInputChange(a){this.onDebouncedSearch(a.detail)}onCertifiedSwitchChange(a){a.detail?(this.badge="certified",H.SnackController.showSvg("Only WalletConnect certified",{icon:"walletConnectBrown",iconColor:"accent-100"})):this.badge=void 0}qrButtonTemplate(){return f.CoreHelperUtil.isMobile()?c.html`
        ...
        ></wui-icon-box>
      `:null}onWalletConnectQr(){q.RouterController.push("ConnectingWalletConnect")}};bF([(0,d.state)()],bG.prototype,"search",void 0),bF([(0,d.state)()],bG.prototype,"badge",void 0),bG=bF([(0,i.customElement)("w3m-all-wallets-view")],bG),a.s(["W3mAllWalletsView",()=>bG],273009);var bH=b,bI=b;let bJ=y.css`
  :host {
    width: 100%;
  }
...
`;var bK=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g};let bL=class extends bI.LitElement{constructor(){super(...arguments),this.imageSrc="google",this.loading=!1,this.disabled=!1,this.rightIcon=!0,this.rounded=!1,this.fullSize=!1}render(){return this.dataset.rounded=this.rounded?"true":"false",c.html`
      <button
    ...
    `}templateLeftIcon(){return this.icon?c.html`<wui-image
      ...
      src=${this.imageSrc}
    ></wui-image>`}templateRightIcon(){return this.rightIcon?this.loading?c.html`<wui-loading-spinner size="md" color="accent-primary"></wui-loading-spinner>`:c.html`<wui-icon name="chevronRight" size="lg" color="default"></wui-icon>`:null}};bL.styles=[L.resetStyles,L.elementStyles,bJ],bK([(0,k.property)()],bL.prototype,"imageSrc",void 0),bK([(0,k.property)()],bL.prototype,"icon",void 0),bK([(0,k.property)()],bL.prototype,"iconColor",void 0),bK([(0,k.property)({type:Boolean})],bL.prototype,"loading",void 0),bK([(0,k.property)()],bL.prototype,"tabIdx",void 0),bK([(0,k.property)({type:Boolean})],bL.prototype,"disabled",void 0),bK([(0,k.property)({type:Boolean})],bL.prototype,"rightIcon",void 0),bK([(0,k.property)({type:Boolean})],bL.prototype,"rounded",void 0),bK([(0,k.property)({type:Boolean})],bL.prototype,"fullSize",void 0),bL=bK([(0,i.customElement)("wui-list-item")],bL);let bM=class extends bH.LitElement{constructor(){super(...arguments),this.wallet=q.RouterController.state.data?.wallet}render(){if(!this.wallet)throw Error("w3m-downloads-view");return c.html`
    ...
    `:null}openStore(a){a.href&&this.wallet&&(p.EventsController.sendEvent({type:"track",event:"GET_WALLET",properties:{name:this.wallet.name,walletRank:this.wallet.order,explorerId:this.wallet.id,type:a.type}}),f.CoreHelperUtil.openHref(a.href,"_blank"))}onChromeStore(){this.wallet?.chrome_store&&this.openStore({href:this.wallet.chrome_store,type:"chrome_store"})}onAppStore(){this.wallet?.app_store&&this.openStore({href:this.wallet.app_store,type:"app_store"})}onPlayStore(){this.wallet?.play_store&&this.openStore({href:this.wallet.play_store,type:"play_store"})}onHomePage(){this.wallet?.homepage&&this.openStore({href:this.wallet.homepage,type:"homepage"})}};bM=function(a,b,c,d){var e,f=arguments.length,g=f<3?b:null===d?d=Object.getOwnPropertyDescriptor(b,c):d;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)g=Reflect.decorate(a,b,c,d);else for(var h=a.length-1;h>=0;h--)(e=a[h])&&(g=(f<3?e(g):f>3?e(b,c,g):e(b,c))||g);return f>3&&g&&Object.defineProperty(b,c,g),g}([(0,i.customElement)("w3m-downloads-view")],bM),a.s(["W3mDownloadsView",()=>bM],638292),a.s([],993480),a.i(993480),a.i(651415),a.i(273009),a.i(638292),a.s(["W3mAllWalletsView",()=>bG,"W3mConnectingWcBasicView",()=>aO,"W3mDownloadsView",()=>bM],920251)}];
